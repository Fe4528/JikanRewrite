...
module.exports = {
    ...
    async run(client, interaction) {
        ...
        .setTitle(getLocaleTranslation(interaction.jikan_server_locale, 'modals.config.JIKAN_MODAL_LB_NAME_CONFIG.title'));
        
        const lb_name_input = new TextInputBuilder()
        .setCustomId("JIKAN_MODAL_LB_NAME_TEXT_INPUT")
        .setStyle(TextInputStyle.Short)
        .setPlaceholder(getLocaleTranslation(interaction.jikan_server_locale, 'modals.config.JIKAN_MODAL_LB_NAME_CONFIG.input_placeholder'))
        .setMaxLength(40)
        .setMinLength(0)
        .setRequired(false);

        const label = new LabelBuilder()
        .setLabel(getLocaleTranslation(interaction.jikan_server_locale, 'modals.config.JIKAN_MODAL_LB_NAME_CONFIG.label_info'))
